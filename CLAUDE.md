# CLAUDE.md — Final Capstone — Deployed AI Solution (HO16)
...
## About this project
Your final capstone — a deployed AI solution.
**Primary way to do it:** Claude.ai / Claude Cowork (design and build it no-code) — **no API key needed.**
...
- It's the **Final Capstone — Deployed AI Solution** hands-on. No-code build primary; live API + deploy is optional/advanced.
